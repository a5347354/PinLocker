...
public abstract class CustomTitleBarActivity extends Activity {
    ...
    protected TextView mTitleBarTitle1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleBarTitle1 = (TextView) findViewById(R.id.title_bar_title1);
        mTitleBarTitle1.setOnClickListener(titleBarOnClickListener);
